const {findProductByDateUser, findProductById}= require("../../services/diary")
const {createNewProduct}=require('../../helpers/diary');
...
const addProduct = async (req, res) => {
    ...
    const checkDate = await findProductByDateUser(date, userId);
    ...
    if (checkDate) {
      ...
      if (!checkedProduct) {
        ...
        checkedProduct.weight += newProduct.weight;
